...
//	}
//	return sum
func L1Norm(x []float64) (sum float64) { _ = "STUB: not implemented"; return 0 }
...
//	}
//	return sum
func L1NormInc(x []float64, n, incX int) (sum float64) { _ = "STUB: not implemented"; return 0 }
...
//		x[i] += alpha
//	}
func AddConst(alpha float64, x []float64) { _ = "STUB: not implemented"; return }
...
//	}
//	return norm
func L1Dist(s, t []float64) float64 { _ = "STUB: not implemented"; return 0 }
...
//	}
//	return norm
func LinfDist(s, t []float64) float64 { _ = "STUB: not implemented"; return 0 }
...
//	    sum += x[i]
//	}
func Sum(x []float64) float64 { _ = "STUB: not implemented"; return 0 }
