...
func (r *Threshold[O]) Operands() []mat.Tensor { _ = "STUB: not implemented"; return nil }
...
func (r *Threshold[O]) Backward(gy mat.Tensor) error { _ = "STUB: not implemented"; return nil }
